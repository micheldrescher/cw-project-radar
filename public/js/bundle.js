...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"util/alert.js":[function(require,module,exports) {
...
},{}],"radar/buildRadar.js":[function(require,module,exports) {
"use strict";
...
function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            overviewSection = radarDiv.append('section').attr('id', 'overview');
  ...
  return function buildRadar(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}(); // plot an individual radar segment


exports.default = buildRadar;

var plotSegment = function plotSegment(parent, index, degrees) {// var quadrantGroup = svg
  //     .append('g')
...
},{"../util/alert":"util/alert.js"}],"radar/showRadar.js":[function(require,module,exports) {
"use strict";
...
var _buildRadar = _interopRequireDefault(require("./buildRadar"));
...
function () {
  ...
  regeneratorRuntime.mark(function _callee(slug) {
    var radarSection, waitingDiv, radarDiv, radarData;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return d3.select('#radar-section');

          case 2:
            radarSection = _context.sent;
            // 1) remove old radar
            radarSection.html(null); // 2) show waiting text

            waitingDiv = radarSection.append('div').attr('id', 'waiting');
            radarDiv = radarSection.append('div').attr('id', 'radar').style('display', 'none');
            plotLoading(waitingDiv);
            _context.prev = 7;
            _context.next = 10;
            return fetchRadar(slug);

          case 10:
            radarData = _context.sent;
            _context.next = 13;
            return (0, _buildRadar.default)(radarDiv, radarData);

          case 13:
            // 5) clear loading
            waitingDiv.remove(); // 6) show radar
  ...
  return function showRadar(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.default = showRadar;

var plotLoading = function plotLoading(waitingDIV) {
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee2(slug) {
    var res;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            return _context2.abrupt("return", res.data.radar);
  ...
  return function fetchRadar(_x2) {
    return _ref2.apply(this, arguments);
  };
}();
},{"axios":"../../node_modules/axios/index.js","../util/alert":"util/alert.js","./buildRadar":"radar/buildRadar.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var _showRadar = _interopRequireDefault(require("./radar/showRadar"));
...
var radarSection = document.getElementById('radar-section'); //
...
if (radarSection) {
  ...
  slug = slug.substring(slug.lastIndexOf('/') + 1); // 2) if no slug, render an error

  if (!slug) {
    (0, _alert.default)('error', 'Invalid URL, no radar id found.', 5);
    return;
  }

  (0, _showRadar.default)(slug);
} // if (mapBox) {
